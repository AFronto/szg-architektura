const createConsultationMW = require("../middleware/data/consultation/createConsultationMW");
const deleteConsultationMW = require("../middleware/data/consultation/deleteConsultationMW");
const updateConsultationMW = require("../middleware/data/consultation/updateConsultationMW");
